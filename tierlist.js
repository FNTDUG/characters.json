   ...
   "lists": {
     "all": {
       ...
       "a": [
         ...
         "DJ 101Bit",
         "Nightterror Rockstar Bonnie",
         "Pirate Withered Foxy",
         "Frostmancer Withered Bonnie",
         "Golden Freddy 0-4-2",
         "Animdude 5-0-2",
         "Vengeful Spirit 5-2-0",
