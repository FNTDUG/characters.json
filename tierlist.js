 ...
 var cfg = {
  ...
  var CSS = [
   ...
   '.tl-row[data-t=op] .tl-nm2{font-size:clamp(26px,5.2vw,32px)}',
    ...
    '.tl-path{position:absolute;bottom:0;right:0;width:32px;height:32px;pointer-events:none;z-index:3}',
    ...
    '.tl-path-pair .tl-path-in img.path-b{transform:translate(-29%,-29%);opacity:.75}',
