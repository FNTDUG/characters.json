...
(function() {
  ...
  var CSS = [
    ...
    '#tlRoot{width:100vw;position:relative;left:50%;transform:translateX(-50%);min-height:100vh;background-color:#090909;color:#fff;padding-bottom:40px;box-sizing:border-box}',
    '#tlRoot *{box-sizing:border-box}',
    '#tlHdr{position:sticky;top:0;z-index:9999;background:rgba(3,3,10,0.97);border-bottom:2px solid rgba(255,215,0,0.2);padding:12px 18px;display:flex;align-items:center;gap:10px;flex-wrap:wrap}',
    '#tlTitle{font-family:Press Start 2P,monospace;font-size:11px;color:#FFD700;text-shadow:0 0 14px rgba(255,215,0,0.6);white-space:nowrap}',
    '.tl-mode{display:flex;gap:6px;flex-wrap:wrap}',
    '.tl-mb{font-family:Press Start 2P,monospace;font-size:7px;padding:9px 12px;background:rgba(0,0,0,0.55);border:2px solid rgba(255,255,255,0.12);color:rgba(255,255,255,0.38);cursor:pointer;white-space:nowrap;transition:all .15s}',
    '.tl-mb:hover{border-color:rgba(255,255,255,0.3);color:rgba(255,255,255,0.65)}',
    '.tl-mb.on{background:rgba(255,215,0,0.12);border-color:#FFD700;color:#FFD700;box-shadow:0 0 12px rgba(255,215,0,0.3),inset 0 0 12px rgba(255,215,0,0.06);text-shadow:0 0 8px rgba(255,215,0,0.6)}',
    ".tl-mb.on::before{content:'\\25BA '}",
    ...
    '.tl-nm2{font-family:Press Start 2P,monospace;font-size:14px;line-height:1.1;color:#FFD700;text-shadow:0 0 12px #FFD700}',
    ...
    '.tl-card{border-radius:12px;padding:2px;border:none;flex-shrink:0;width:80px;cursor:default}',
  ...
  function makeCard(name, isSSZone) {
    var u   = unitMap[name] || {};
