 ...
 var cfg = {
  ...
  var CSS = [
   ...
   '.tl-row[data-t=op] .tl-nm2{font-size:clamp(26px,5.2vw,32px)}',
    ...
    '.tl-path{position:absolute;bottom:7px;right:7px;width:36px;height:36px;pointer-events:none;z-index:3}',
