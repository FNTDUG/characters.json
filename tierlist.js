   ...
   "lists": {
     "all": {
       ...
       "a": [
         ...
         "Stormbound Chica DOWN",
         "Dragon Endo 01",
         "Headless Horseman Mangle UP",
         "Samurai Duo",
         "Candy Cadet",
         "Theory Crusher Scott UP",
         "Frozen King Foxy DOWN",
         ...
         "Golden Cupcake",
         "Party Never Ends Cupcake UP",
         "Funtime Foxy UP",
         "Psychic Friend Fredbear",
         "Unicorn Toy Foxy UP",
         "Molten Freddy UP",
         "Aqua Strike Toy Chica UP",
         "Sole Survivor Withered Bonnie",
         "Lolbit UP",
         "Spirit of William Afton UP",
         "Shark Withered Foxy UP",
         "Commander Withered Freddy DOWN",
         "Valkyrie Chica DOWN",
         "Nightguard Afton",
         "Endo 01",
         "Cannoneer Chica",
         ...
         "Ragequit Scott DOWN",
         "Amalgam DOWN",
         "Nightmare Shadow Bonnie DOWN",
         "HandUnit",
         "Chicas Magic Rainbow",
         "Lore Keeper Shadow Bonnie",
         "Mothman Lefty",
         "Phantom Withered Chica NEW",
         "Henry Emily",
         "Mechanic Endo 01",
         "Fredtrap",
         "Lefty",
         ...
         "Funtime Chica",
         "Mecha-Lizabeth BUG",
         "Ignited Burst Withered Freddy UP",
         "Bombwork Cupcake UP",
         "Anti-Hero Mike DOWN",
         "Toy Maker Mangle",
         "Dutchman Nightmare Bonnie UP",
         ...
         "Fazcade DOWN",
         "Super Soldier Foxy DOWN",
         "Salvaged Toy Bonnie DOWN",
       ],
       "b": [
         "Mangle DOWN",
         "Springtrap DOWN",
