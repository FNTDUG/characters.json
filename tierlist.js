(function() {
  ...
  var CSS = [
    ...
    '#tlTitle{font-family:"Press Start 2P",monospace;font-size:11px;color:#681f62;text-shadow:0 0 14px rgba(104,31,98,0.85);white-space:nowrap}',
    ...
    '.tl-nm2{font-family:Arial,Helvetica,sans-serif;font-weight:800;font-size:18px;line-height:1.1;color:#FFD700;text-shadow:0 0 12px #FFD700}',
